...
export function buttonClasses({
  ...
  return classNames(
    ...
    size === "large" && "h-14 rounded-xl px-12",
    size === "medium" && "h-12 rounded-xl px-10",
    size === "small" && "h-8 rounded-lg px-8",
    variant === "primary" &&
      "text-white bg-brand-500 hover:text-white hover:bg-brand-700",
    variant === "secondary" &&
      "border border-brand-500 text-brand-500 border-secondary bg-white hover:text-brand-700 hover:border-brand-700",
